...
public final class VPConfig {
    ...
    private static final ForgeConfigSpec.IntValue EXP_AMOUNT;
    private static final ForgeConfigSpec.IntValue MAX_EXP_AMOUNT;
    private static final ForgeConfigSpec.IntValue ALCHEMIST_EXPLOSION_CHANCE;
    /** Keyed "<village type>_<profession>". */
    private static final Map<String, ForgeConfigSpec.IntValue> STRUCTURE_WEIGHTS = new LinkedHashMap<>();
    ...
    public static int structureWeight(String key) {
        ForgeConfigSpec.IntValue value = STRUCTURE_WEIGHTS.get(key);
