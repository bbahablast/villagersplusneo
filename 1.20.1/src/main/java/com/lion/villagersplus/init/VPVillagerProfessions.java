...
public final class VPVillagerProfessions {
    ...
    public static final DeferredRegister<VillagerProfession> PROFESSIONS =
            DeferredRegister.create(ForgeRegistries.VILLAGER_PROFESSIONS, VillagersPlus.MOD_ID);
    ...
    public static final RegistryObject<VillagerProfession> HORTICULTURIST =
            register("horticulturist", HORTICULTURIST_SITE, SoundEvents.VILLAGER_WORK_FARMER);

    public static final RegistryObject<VillagerProfession> OCEANOGRAPHER =
            register("oceanographer", matches(VPPointOfInterestTypes.OCEANOGRAPHER), SoundEvents.BUCKET_FILL);

    public static final RegistryObject<VillagerProfession> OCCULTIST =
    ...
    private static Predicate<Holder<PoiType>> matches(RegistryObject<PoiType> poi) {
        return holder -> holder.value() == poi.get();
    }

    private static RegistryObject<VillagerProfession> register(
